...
import { AddressM, LocationM } from '../../../models/Address';
...
@Component({
  ...
  styleUrl: './modal-address.css',
})
export class ModalAddress {
  @Input() address: AddressM | null = null;
  @Input() isEditMode: boolean = false;
  @Output() submit = new EventEmitter<AddressM>();
