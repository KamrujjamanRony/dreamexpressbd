...
import { MenuItem, UserDeleteResponseM, UserFormM, UserFormResponseM, UserM, UsersM } from '../models/User';
...
export class SUser {
  ...
  generateTreeData(userId: any = ''): Observable<MenuItem[]> {
    return this.http.get<MenuItem[]>(`${environment.apiUrl}/Menu/GenerateTreeData?userId=${userId}`);
  }
